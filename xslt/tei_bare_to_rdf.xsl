    ...
    <xsl:template match="/">
        <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            ...
            <rdf:Description>
                ...
                <!-- add rdf for the teiHeader section -->
                <!-- creates relationship for title elements within the titleStmt tag -->
                <xsl:for-each select="/tei:TEI/tei:teiHeader/tei:fileDesc/titleStmt//tei:title">
                    <dct:title>
                        <xsl:value-of select="."/>
                    </dct:title>
                </xsl:for-each>
                
                <!-- creates relationship for author elements within the teiHeader tag -->
                ...
                <!-- creates relationship for publisher elements within the teiHeader tag -->
